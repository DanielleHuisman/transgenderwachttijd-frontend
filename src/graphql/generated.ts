...
export type ServiceTimeFragment = {
    __typename?: 'ServiceTime';
    id: string;
    date: string;
    days?: number | null;
...
export type GetGraphQuery = {
    ...
    graph: Array<{
        ...
        id: string;
        label: string;
        data: Array<{__typename?: 'ServiceTime'; date: string; days?: number | null; isIndividual: boolean}>;
    }>;
};
...
export type GetServiceAgeGroupsQuery = {
    __typename?: 'Query';
    serviceAgeGroups: Array<{__typename?: 'ServiceAgeGroup'; id: string; name: string}>;
};
...
export type GetServiceTypesQuery = {
    __typename?: 'Query';
    serviceTypes: Array<{__typename?: 'ServiceType'; id: string; name: string}>;
};
...
} as unknown as DocumentNode<ProviderFragment, unknown>;
export const ServiceAgeGroupFragmentDoc = {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: {kind: 'Name', value: 'ServiceAgeGroupFragment'},
            typeCondition: {kind: 'NamedType', name: {kind: 'Name', value: 'ServiceAgeGroup'}},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {kind: 'Field', name: {kind: 'Name', value: 'id'}},
...
} as unknown as DocumentNode<ServiceAgeGroupFragment, unknown>;
    ...
    definitions: [
        {
            ...
            typeCondition: {kind: 'NamedType', name: {kind: 'Name', value: 'Service'}},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {kind: 'Field', name: {kind: 'Name', value: 'id'}},
                    {kind: 'Field', name: {kind: 'Name', value: 'name'}},
                    {kind: 'Field', name: {kind: 'Name', value: 'medicalName'}},
...
export const ServiceOfferingFragmentDoc = {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: {kind: 'Name', value: 'ServiceOfferingFragment'},
            typeCondition: {kind: 'NamedType', name: {kind: 'Name', value: 'ServiceOffering'}},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {kind: 'Field', name: {kind: 'Name', value: 'id'}},
...
} as unknown as DocumentNode<ServiceOfferingFragment, unknown>;
export const ServiceTimeFragmentDoc = {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: {kind: 'Name', value: 'ServiceTimeFragment'},
            typeCondition: {kind: 'NamedType', name: {kind: 'Name', value: 'ServiceTime'}},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {kind: 'Field', name: {kind: 'Name', value: 'id'}},
                    ...
                    {kind: 'Field', name: {kind: 'Name', value: 'isIndividual'}}
                ]
            }
        }
    ]
} as unknown as DocumentNode<ServiceTimeFragment, unknown>;
export const ServiceTypeFragmentDoc = {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: {kind: 'Name', value: 'ServiceTypeFragment'},
...
} as unknown as DocumentNode<ServiceTypeFragment, unknown>;
            ...
            variableDefinitions: [
                {
                    ...
                    variable: {kind: 'Variable', name: {kind: 'Name', value: 'providerIds'}},
                    type: {
                        kind: 'NonNullType',
                        type: {
                            kind: 'ListType',
                ...
                {
                    kind: 'VariableDefinition',
                    variable: {kind: 'Variable', name: {kind: 'Name', value: 'serviceIds'}},
                    type: {
                        kind: 'NonNullType',
                        type: {
                            kind: 'ListType',
                ...
                {
                    kind: 'VariableDefinition',
                    variable: {kind: 'Variable', name: {kind: 'Name', value: 'serviceAgeGroupIds'}},
                    type: {
                        kind: 'NonNullType',
                        type: {
                            kind: 'ListType',
                ...
                {
                    kind: 'VariableDefinition',
                    variable: {kind: 'Variable', name: {kind: 'Name', value: 'serviceTypeIds'}},
                    type: {
                        kind: 'NonNullType',
                        type: {
                            kind: 'ListType',
                ...
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                kind: 'Argument',
                                name: {kind: 'Name', value: 'providerIds'},
                                value: {kind: 'Variable', name: {kind: 'Name', value: 'providerIds'}}
                            },
                            {
                                kind: 'Argument',
                                name: {kind: 'Name', value: 'serviceIds'},
                                value: {kind: 'Variable', name: {kind: 'Name', value: 'serviceIds'}}
                            },
                            {
                                kind: 'Argument',
                                name: {kind: 'Name', value: 'serviceAgeGroupIds'},
                                value: {kind: 'Variable', name: {kind: 'Name', value: 'serviceAgeGroupIds'}}
                            },
                            {
                                kind: 'Argument',
                                name: {kind: 'Name', value: 'serviceTypeIds'},
                                value: {kind: 'Variable', name: {kind: 'Name', value: 'serviceTypeIds'}}
                            },
                            {
                                kind: 'Argument',
...
export const GetServiceAgeGroupsDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: {kind: 'Name', value: 'GetServiceAgeGroups'},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                        kind: 'Field',
                        name: {kind: 'Name', value: 'serviceAgeGroups'},
                        arguments: [
                            {
                                kind: 'Argument',
                                name: {kind: 'Name', value: 'order'},
                        ...
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [
                                {kind: 'FragmentSpread', name: {kind: 'Name', value: 'ServiceAgeGroupFragment'}}
                            ]
                        }
                    }
                ]
...
} as unknown as DocumentNode<GetServiceAgeGroupsQuery, GetServiceAgeGroupsQueryVariables>;
export const GetServiceTreeDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: {kind: 'Name', value: 'GetServiceTree'},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                        kind: 'Field',
                        name: {kind: 'Name', value: 'serviceTree'},
                        arguments: [
                            {
                                kind: 'Argument',
                                name: {kind: 'Name', value: 'order'},
                        ...
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [
                                {kind: 'FragmentSpread', name: {kind: 'Name', value: 'ServiceFragment'}},
                                {
                                    kind: 'Field',
...
} as unknown as DocumentNode<GetServiceTreeQuery, GetServiceTreeQueryVariables>;
export const GetServiceTypesDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: {kind: 'Name', value: 'GetServiceTypes'},
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                        ...
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [{kind: 'FragmentSpread', name: {kind: 'Name', value: 'ServiceTypeFragment'}}]
                        }
                    }
                ]
            }
...
} as unknown as DocumentNode<GetServiceTypesQuery, GetServiceTypesQueryVariables>;
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [{kind: 'FragmentSpread', name: {kind: 'Name', value: 'ServiceFragment'}}]
                        }
                    }
                ]
            }
